...
3. Elegí tu fork `TU-USUARIO/UAI-PII-2026-2` de la lista y una carpeta local donde guardarlo. Click en **Clone**.
...
2. Se abre GitHub en el navegador. Verificá que:
   ...
   - **head repository**: `TU-USUARIO/UAI-PII-2026-2`, rama `tpN-apellido-nombre`
...
- **No me aparece el botón "Create pull request"**: entrá directamente a `https://github.com/TU-USUARIO/UAI-PII-2026-2/pull/new/tpN-apellido-nombre`.
